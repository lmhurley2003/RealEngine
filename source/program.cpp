...
const std::vector<const unsigned char*> Program::shaders = {triBufferMatrixVert, triBufferSimpleFrag };
const std::vector<uint32_t> Program::shaderSizes = {triBufferMatrixVertSize, triBufferSimpleFragSize};

Program curProgram() { return  Program(parameters, {}, {}, { {MAIN_RENDER, {{VERTEX, 0}, {FRAGMENT, 1}}} }); };
